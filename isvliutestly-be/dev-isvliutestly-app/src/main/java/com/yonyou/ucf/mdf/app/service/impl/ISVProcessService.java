...
//			throw new IllegalArgumentException("获取BpmRest时传入的userId[" + userId + "]是空");
     ...
     * @throws Exception
     */
    public void startBpm(UIMetaBaseInfo uiMetaBaseInfo, List<BizObject> bills) throws Exception {
        int submitCount = 0;
     ...
     * 撤回
     */
    public void withdraw(UIMetaBaseInfo uiMetaBaseInfo, List<BizObject> bills) throws Exception {
        for (BizObject bill : bills) {
    ...
    public List<BizObject> abandonAudit(UIMetaBaseInfo uiMetaBaseInfo, List<BizObject> bills) throws Exception {
     ...
     * 保存时判断是否受审批流控制
     */
    public boolean bpmControl(UIMetaBaseInfo uiMetaBaseInfo, BizObject bill) throws Exception {
    ...
    public void updateBpmProcess(UIMetaBaseInfo uiMetaBaseInfo, BizObject bill) throws Exception {
        List<RestVariable> variables = prepareVariables(bill);
        String businessKey = String.format("%s_%s", uiMetaBaseInfo.getBillnum(), getIdStr(bill));
    ...
    public String complete(BpmRequestBody params) {
        ...
        try {
            BaseReqDto<String, String, String> dto = checkCompleteIdentity(params);
     ...
     * @return
     */
    private String getMasterOrg(UIMetaBaseInfo uiMetaBaseInfo, BizObject bill) {
     ...
     * @return
     */
    private String getTransactionType(UIMetaBaseInfo uiMetaBaseInfo, BizObject bill) {
        String transactionTypeField = MetaAttributeUtils.getAttributeField(uiMetaBaseInfo.getFullname(), "isTransactionType", "bustype");//交易类型标识
        return "" + bill.get(transactionTypeField);
    }

    private String getCode(UIMetaBaseInfo uiMetaBaseInfo, BizObject bill) {
     ...
     * 转化请求Dto, 模拟登陆
     */
    private BaseReqDto<String, String, String> checkCompleteIdentity(BpmRequestBody params) throws Exception {
        ...
        BaseReqDto<String, String, String> dto = new BaseReqDto<>();
