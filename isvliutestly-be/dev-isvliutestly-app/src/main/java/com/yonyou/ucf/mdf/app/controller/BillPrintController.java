...
public class BillPrintController extends BaseController {
    ...
    public void getTemplateByBo(@RequestParam(value = "billno", required = true) String billno, @RequestParam(value = "domain", required = false) String domain, HttpServletRequest request, HttpServletResponse response)throws Exception{
        try {
