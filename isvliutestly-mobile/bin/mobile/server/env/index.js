    ...
    for (var dev in ifaces) {
      ...
      ifaces[dev].forEach(function (details) {
        if (details.family == 'IPv4') {
          ...
          ips.push(details.address); // ++alias;
        }
      });
    }
...
var HTTP_SERVICE_BASEURL = _config.default.HTTP_SERVICE_BASEURL,
    HTTP_TPL_SERVER_URL = _config.default.HTTP_TPL_SERVER_URL;
var env = {
  ...
  HTTP_SERVER_PORT: _config.default.HTTP_SERVER_PORT || 3003,
  HTTP_SCRIPT_SUFFIX: '',
  ...
  HTTP_USER_COR_ACC: combine(HTTP_SERVICE_BASEURL, '/login/getCorpAccounts'),
  // gen()
