...
exports.DateDiff = exports.Format = exports.getDate = void 0;

// copy from pc
var getDate = function getDate(type, index) {
  var self = this;
  ...
  switch (type) {
    ...
    case 'lastmonth':
      ...
      if (index == 0) {
        ...
        var _monthStartDate = new Date(nowYear, lastMonth, 1);

        var _monthEndDate = new Date(nowYear, lastMonth + 1, 1);

        var _days = (_monthEndDate - _monthStartDate) / (1000 * 60 * 60 * 24);

        return self.Format(new Date(nowYear, lastMonth, _days));
      }
    ...
    case 'quarter':
      ...
      if (index == 0) {
        ...
        var _monthStartDate2 = new Date(nowYear, nowMonth, 1);

        var _monthEndDate2 = new Date(nowYear, quarter_start + 3, 1);

        var _days2 = (_monthEndDate2 - _monthStartDate2) / (1000 * 60 * 60 * 24);

        return self.Format(new Date(nowYear, nowMonth, _days2));
      }
    ...
    case 'year':
      ...
      if (index == 0) {
        ...
        var _monthStartDate3 = new Date(nowYear, 11, 1);

        var _monthEndDate3 = new Date(nowYear, 11 + 1, 1);

        var _days3 = (_monthEndDate3 - _monthStartDate3) / (1000 * 60 * 60 * 24);

        return self.Format(new Date(nowYear, 11, _days3));
      }
    ...
    case 'lastyear':
      ...
      if (index == 0) {
        ...
        var _monthStartDate4 = new Date(lastYear, 11, 1);

        var _monthEndDate4 = new Date(lastYear, 11 + 1, 1);

        var _days4 = (_monthEndDate4 - _monthStartDate4) / (1000 * 60 * 60 * 24);

        return self.Format(new Date(lastYear, 11, _days4));
      }
...
var Format = function Format(date, format) {
...
var DateDiff = function DateDiff(sDate1, sDate2) {
