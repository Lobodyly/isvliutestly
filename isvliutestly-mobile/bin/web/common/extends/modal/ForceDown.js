...
var ForceDown = /*#__PURE__*/function (_Component) {
  _inherits(ForceDown, _Component);

  var _super = _createSuper(ForceDown);

  function ForceDown(props) {
    var _this;

    _classCallCheck(this, ForceDown);
