...
var CopyBrandClassurl = /*#__PURE__*/function (_Component) {
  _inherits(CopyBrandClassurl, _Component);

  var _super = _createSuper(CopyBrandClassurl);

  function CopyBrandClassurl(props) {
    var _this;

    _classCallCheck(this, CopyBrandClassurl);
  ...
  _createClass(CopyBrandClassurl, [{
    ...
    value: function render() {
      var erpCode = this.geturl() || '没有商品地址';
  ...
  return CopyBrandClassurl;
}(_react.Component);

exports.default = CopyBrandClassurl;