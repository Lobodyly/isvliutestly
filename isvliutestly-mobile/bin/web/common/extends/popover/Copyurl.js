...
var Copyurl = /*#__PURE__*/function (_Component) {
  _inherits(Copyurl, _Component);

  var _super = _createSuper(Copyurl);
  ...
  _createClass(Copyurl, [{
    ...
    value: function geturl() {
      ...
      var goods_id = this.state.data.id;
      var shopId = this.state.data.shopId; // let params=null;
      // if(org_id){
